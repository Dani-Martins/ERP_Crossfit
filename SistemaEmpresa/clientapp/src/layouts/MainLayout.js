      ...
      <div className="sidebar bg-dark">
        ...
        <ul className="nav flex-column sidebar-nav">
          ...
          <li className={`nav-item ${isActive('/produtos') ? 'active' : ''}`}>
            <Link to="/produtos" className="nav-link text-white d-flex align-items-center px-3 py-2">
          ...
          <li className={`nav-item ${isActive('/funcionarios') ? 'active' : ''}`}>
            <Link to="/funcionarios" className="nav-link text-white d-flex align-items-center px-3 py-2">
